...
(
    ...
    constraint title_title_type_bokbasen_codelist_list_code_fkey foreign key (title_type_list, title_type_code) references bokbasen_codelist (list, code)
);
...
(
    ...
    constraint manifestation_title_type_bokbasen_codelist_list_code_fkey foreign key (title_type_list, title_type_code) references bokbasen_codelist (list, code)
);